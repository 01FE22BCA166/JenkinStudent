...
public class Demo {
    public static void main(String[] args) {
        Student student1 = new Student("Nandish ", "Computer Science", "Engineering");
        student1.addCourse("Mathematics", 80);
        student1.addCourse("Physics", 35);
        student1.addCourse("Programming", 95);
